...
const MOCK_ATHLETES: Athlete[] = [
  ...
  },
  {
    ...
    monitoring: {
      ...
      dryAttendance: 100,
      dryHistory: [
         { date: 'S1', rpe: 8, attendance: 'PRESENT' }, 
         { date: 'S2', rpe: 9, attendance: 'PRESENT' }
      ],
  ...
  },
  {
    ...
    nutritionHistory: [],
    stats: { goals: 5, fouls: 2, matchesPlayed: 4, exclusions: 1 },
  ...
  },
  {
    ...
    nutritionHistory: [],
    stats: { goals: 20, fouls: 10, matchesPlayed: 10, exclusions: 5 },
  ...
  },
  {
    ...
    nutritionHistory: [],
    stats: { goals: 8, fouls: 8, matchesPlayed: 9, exclusions: 3 },
  ...
  },
  {
    ...
    nutritionHistory: [],
    stats: { goals: 1, fouls: 0, matchesPlayed: 2, exclusions: 0 },
